	...
	prize_list = list(
		...
		list(
			...
			"products" = list(
				...
				new /datum/data/mining_equipment("Power Tool - Upgraded T-Ray Scanner",         /obj/item/t_scanner/upgraded,           40),
				new /datum/data/mining_equipment("Power Tool - Advanced T-Ray Scanner",         /obj/item/t_scanner/advanced,           80),
				new /datum/data/mining_equipment("Power Tool - Long Range Atmosphere scanner",  /obj/item/atmos_analyzer/longrange,     60),
