/obj/machinery/mineral/equipment_vendor/survey
	...
	prize_list = list(
		...
		list(
			"name" = "Defense",
			"products" = list(
				new /datum/data/mining_equipment("Smoke Bomb",/obj/item/grenade/smokebomb,								10),
				new /datum/data/mining_equipment("Steel Machete",	/obj/item/material/knife/machete,					75),
				new /datum/data/mining_equipment("Kinetic Dagger",	/obj/item/kinetic_crusher/dagger,					75),
				new /datum/data/mining_equipment("Razor Drone Deployer",	/obj/item/grenade/spawnergrenade/manhacks/station/locked,		100),
				new /datum/data/mining_equipment("Sentry Drone Deployer",	/obj/item/grenade/spawnergrenade/ward,							150),
				new /datum/data/mining_equipment("Marksman Box",	/obj/item/gunbox/marksman,							1000),
			)
		),
		list(
			"name" = "Survival",
